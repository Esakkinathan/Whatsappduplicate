...
import com.example.whatsappduplicate.ImageViewActivity;
...
public class MessageAdaptar extends RecyclerView.Adapter<MessageAdaptar.MessageViewHolder> {
    ...
    Context context;
    public MessageAdaptar(List<Messages> userMessageLIST, Context context)
    {
    ...
    @NonNull
    @Override
    public MessageAdaptar.MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MessageAdaptar.MessageViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (fromMessageType.equals("text-link"))
        {
            if (fromUserId.equals(messageSenderId)) {
                holder.senderMessageText.setVisibility(View.VISIBLE);
                holder.senderMessageTexttd.setVisibility(View.VISIBLE);
                holder.sender.setVisibility(View.VISIBLE);
                SpannableString spannableString = new SpannableString(messages.getMessage());
                Linkify.addLinks(spannableString, Linkify.WEB_URLS);
                holder.senderMessageText.setText(spannableString);
                holder.senderMessageTexttd.setText(messages.getTime() + " " + messages.getDate());
            }
            else
            {
                ...
                SpannableString spannableString = new SpannableString(messages.getMessage());
                Linkify.addLinks(spannableString, Linkify.WEB_URLS);
                holder.receiverMessageText.setText(spannableString);
                holder.receiverMessageTexttd.setText(messages.getTime() + " " + messages.getDate());
            }
            holder.senderImageView.setVisibility(View.GONE);
            holder. receiverImageView.setVisibility(View.GONE);
        ...
        if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            if (fromUserId.equals(messageSenderId)) {
                holder.senderImageView.setVisibility(View.VISIBLE);
                holder.senderImageView.setBackgroundResource(R.drawable.file_file);
                holder.receiverImageView.setVisibility(View.GONE);
            ...
            {
                holder.receiverImageView.setVisibility(View.VISIBLE);
                holder.receiverImageView.setBackgroundResource(R.drawable.file_file);
                holder.senderImageView.setVisibility(View.GONE);
...

        {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (messages.getType().equals("text-link") )
                    {
                        CharSequence options[]=new CharSequence[]
                                {
                                        "Delete for Me",
                                        "Cancel",
                                        "Open and view this link",
                                        "Delete for EveryOne"
                                };
                        AlertDialog.Builder builder=new AlertDialog.Builder(holder.itemView.getContext());
                        builder.setTitle("Delete Message");
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(i==2){
                                    String url = messages.getMessage();
