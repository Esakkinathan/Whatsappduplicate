package com.example.whatsappduplicate.Fragments;
...
import com.example.whatsappduplicate.ChatActivity;
import com.example.whatsappduplicate.FindFriends;
import com.example.whatsappduplicate.helper.Contacts;
    ...
    private void GetImage(String currentUser, CircleImageView imageView) {
        ...
        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                if (isAdded()) { // Check if the fragment is attached before loading the image
